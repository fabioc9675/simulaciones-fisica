      ...
      <Router>
        <Switch>
          ...
          <Route
            forceRefresh={true}
            exact
            path={dataSim.simGaDi20232.path}
            component={() => (
              <SimFrame
                paneTitle={dataSim.simGaDi20232.title}
                url={dataSim.simGaDi20232.url}
                doc={dataSim.simGaDi20232.doc}
                act={dataSim.simGaDi20232.act}
                author={dataSim.simGaDi20232.author}
                email={dataSim.simGaDi20232.email}
              />
            )}
          />
          <Route
            forceRefresh={true}
            exact
            path={dataSim.simRaDe20232.path}
            component={() => (
              <SimFrame
                paneTitle={dataSim.simRaDe20232.title}
                url={dataSim.simRaDe20232.url}
                doc={dataSim.simRaDe20232.doc}
                act={dataSim.simRaDe20232.act}
                author={dataSim.simRaDe20232.author}
                email={dataSim.simRaDe20232.email}
              />
            )}
          />
